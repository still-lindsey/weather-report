...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"ada-project-docs/assets/rain_sky.jpg":[function(require,module,exports) {
module.exports = "/rain_sky.7a5b0347.jpg";
},{}],"ada-project-docs/assets/broken_clouds_sky.jpg":[function(require,module,exports) {
module.exports = "/broken_clouds_sky.9c13d49e.jpg";
},{}],"ada-project-docs/assets/thunderstorm_sky.jpg":[function(require,module,exports) {
module.exports = "/thunderstorm_sky.d7bacd09.jpg";
},{}],"ada-project-docs/assets/clear_sky.jpg":[function(require,module,exports) {
module.exports = "/clear_sky.0b207436.jpg";
},{}],"ada-project-docs/assets/mist_sky.jpg":[function(require,module,exports) {
module.exports = "/mist_sky.cc092ef4.jpg";
},{}],"ada-project-docs/assets/snow_sky.jpg":[function(require,module,exports) {
module.exports = "/snow_sky.fa1a91c0.jpg";
},{}],"ada-project-docs/assets/winter_landscape.png":[function(require,module,exports) {
module.exports = "/winter_landscape.d5077757.png";
},{}],"ada-project-docs/assets/summer_landscape.png":[function(require,module,exports) {
module.exports = "/summer_landscape.3e98ae10.png";
},{}],"ada-project-docs/assets/spring_landscape.png":[function(require,module,exports) {
module.exports = "/spring_landscape.f56c79d9.png";
},{}],"ada-project-docs/assets/fall_landscape.png":[function(require,module,exports) {
module.exports = "/fall_landscape.acf2a682.png";
},{}],"ada-project-docs/assets/hottest_landscape.png":[function(require,module,exports) {
module.exports = "/hottest_landscape.c19ffdb2.png";
...
var registerEventHandlers = function registerEventHandlers() {
  ...
  document.getElementById("up-temp").addEventListener('click', function () {
    return changeTemp(1);
  });
  ...
  var skyConditions = document.getElementsByClassName("weather-dropdown-item");

  var _iterator = _createForOfIteratorHelper(skyConditions),
      _step;
  ...
  try {
    var _loop = function _loop() {
      ...
      condition.addEventListener("click", function () {
        return toggleSky(condition.textContent);
      });
    };
...
var switchFAndC = function switchFAndC() {
...
var weatherMainToIcon = (_weatherMainToIcon = {
  "THUNDERSTORM": ["bi-cloud-lightning-rain", imgObject['thunderstormSky']],
  "DRIZZLE": ["bi-cloud-drizzle", imgObject['rainSky']],
  "RAIN": ["bi-cloud-rain", imgObject['rainSky']],
  "SNOW": ["bi-cloud-snow", imgObject['snowSky']],
  "MIST": ["bi-cloud-haze", imgObject['mistSky']],
  "SMOKE": ["bi-cloud-fog", imgObject['mistSky']],
  "HAZE": ["bi-cloud-haze", imgObject['mistSky']],
  "DUST": ["bi-cloud-fog", imgObject['mistSky']],
  "FOG": ["bi-cloud-haze", imgObject['mistSky']],
  "SAND": ["bi-cloud-fog", imgObject['mistSky']]
}, _defineProperty(_weatherMainToIcon, "DUST", ["bi-cloud-fog", imgObject['mistSky']]), _defineProperty(_weatherMainToIcon, "ASH", ["bi-cloud-fog", imgObject['mistSky']]), _defineProperty(_weatherMainToIcon, "SQUALL", ["bi-cloud-fog", imgObject['mistSky']]), _defineProperty(_weatherMainToIcon, "TORNADO", ["bi-cloud-fog", imgObject['mistSky']]), _defineProperty(_weatherMainToIcon, "CLEAR", ["bi-sun", imgObject['clearSky']]), _defineProperty(_weatherMainToIcon, "CLOUDS", ['bi-clouds', imgObject['cloudsSky']]), _weatherMainToIcon);

var displayWeatherAtLocationAsync = function displayWeatherAtLocationAsync() {
  navigator.geolocation.getCurrentPosition( /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return getWeather(state.currentLat, state.currentLon);
    ...
    if (error.code === error.PERMISSION_DENIED) {
      ...
      setTimeout(function () {
        return window.alert("Enable browser location access or type your city/region in the dropdown search to access current local weather information.");
      }, 2000);
    }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get("https://weather-report-server.herokuapp.com/city", {
              params: {
          ...
          case 3:
            ...
            return _context2.abrupt("return", cityResponse.data.address.city || cityResponse.data.address.region || cityResponse.data.address.county);

          case 8:
            _context2.prev = 8;
            _context2.t0 = _context2["catch"](0);
            console.log("error with getting city", _context2.t0);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  displayWeatherAtLocationAsync();
});

var changeTemp = function changeTemp(change) {
  if (state.tempMetric === "F") {
...
var checkSeasonChange = function checkSeasonChange() {
...
var checkTextColorChange = function checkTextColorChange() {
...
var changeWeatherAsync = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var q, _yield$getLatLon, lat, lon, weatherResponse;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            _yield$getLatLon = _context3.sent;
            lat = _yield$getLatLon.lat;
            lon = _yield$getLatLon.lon;
            _context3.next = 8;
            return getWeather(lat, lon);

          case 8:
            weatherResponse = _context3.sent;
            updateState(weatherResponse);
            updateUI();
  ...
  return function changeWeatherAsync() {
    return _ref3.apply(this, arguments);
  };
}();

var getLatLon = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(q) {
    var response;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _axios.default.get("https://weather-report-server.herokuapp.com/location", {
              params: {
                q: q
              }
            });
          ...
          case 8:
            ...
            console.log('location error', _context4.t0);
  ...
  return function getLatLon(_x2) {
    return _ref4.apply(this, arguments);
  };
}();

var getWeather = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(lat, lon) {
    var response;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return _axios.default.get("https://weather-report-server.herokuapp.com/weather", {
              params: {
                lat: lat,
                lon: lon
              }
          ...
          case 8:
            ...
            console.log('weather error!', _context5.t0);
  ...
  return function getWeather(_x3, _x4) {
    return _ref5.apply(this, arguments);
  };
}();

var updateState = function updateState(weatherResponse) {
...
var setTemp = function setTemp() {
  if (state.tempMetric === "F") {
    document.getElementById("temp").innerHTML = "".concat(Math.round(state.temperatureF), "&deg;");
  } else {
    document.getElementById("temp").innerHTML = "".concat(Math.round(state.temperatureC), "&deg;");
  }
...
var setSky = function setSky() {
  document.body.style.background = "url(".concat(state.skyImg, ") no-repeat top fixed");
  document.body.style.backgroundSize = '100% 100%';
};

var setWeatherIcon = function setWeatherIcon() {
  document.getElementsByClassName("weather-icon")[1].classList.replace(state.oldIconName, state.weatherIconName);
};

var setWeatherDescription = function setWeatherDescription() {
  document.getElementById("wdescription").textContent = state.weatherDescription;
};

var toggleSky = function toggleSky(condition) {
...
//   });
// }
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js","/ada-project-docs/assets/rain_sky.jpg":"ada-project-docs/assets/rain_sky.jpg","/ada-project-docs/assets/broken_clouds_sky.jpg":"ada-project-docs/assets/broken_clouds_sky.jpg","/ada-project-docs/assets/thunderstorm_sky.jpg":"ada-project-docs/assets/thunderstorm_sky.jpg","/ada-project-docs/assets/clear_sky.jpg":"ada-project-docs/assets/clear_sky.jpg","/ada-project-docs/assets/mist_sky.jpg":"ada-project-docs/assets/mist_sky.jpg","/ada-project-docs/assets/snow_sky.jpg":"ada-project-docs/assets/snow_sky.jpg","/ada-project-docs/assets/winter_landscape.png":"ada-project-docs/assets/winter_landscape.png","/ada-project-docs/assets/summer_landscape.png":"ada-project-docs/assets/summer_landscape.png","/ada-project-docs/assets/spring_landscape.png":"ada-project-docs/assets/spring_landscape.png","/ada-project-docs/assets/fall_landscape.png":"ada-project-docs/assets/fall_landscape.png","/ada-project-docs/assets/hottest_landscape.png":"ada-project-docs/assets/hottest_landscape.png"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
