...
var switchFAndC = function switchFAndC() {
  if (state.tempMetric === "F") {
    ...
    document.getElementById("temp").innerHTML = "".concat(state.temperatureC, "&deg;");
  } else {
    state.tempMetric = "F";
    document.getElementById("temp").innerHTML = "".concat(state.temperatureF, "&deg;");
  }
};
...
var displayWeatherAtLocation = function displayWeatherAtLocation() {
  navigator.geolocation.getCurrentPosition(function (position) {
    ...
    _axios.default.get("https://weather-report-server.herokuapp.com/weather", {
      params: {
      ...
      _axios.default.get("https://weather-report-server.herokuapp.com/city", {
        params: {
          lat: state.currentLat,
          lon: state.currentLon
        }
        ...
        state.cityName = cityResponse.data.address.city || cityResponse.data.address.region || cityResponse.data.address.county; //Update UI
...
var changeWeatherAsync = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var q, response, lat, lon, weatherResponse;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 16:
            ...
            console.log('weather error!', _context.t0);
          ...
          case 21:
            ...
            console.log('location error', _context.t1);
...
var setSky = function setSky() {
  document.body.style.background = "url(".concat(state.skyImgUrl, ") no-repeat top fixed");
